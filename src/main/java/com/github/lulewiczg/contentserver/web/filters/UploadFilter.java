...
/**
 * Filter to validate user permissions to upload files.
 *
 * @author lulewiczg
 */
@WebFilter(filterName = "UploadFilter", urlPatterns = "/rest/upload/*")
public class UploadFilter implements Filter {
    ...
    public void doFilter(ServletRequest req, ServletResponse resp, FilterChain chain) throws IOException, ServletException {
        ...
        if (path != null && !ResourceUtil.get(context).hasWriteAccess(path, user)) {
            Log.getLog().logWriteDenied(path, session, req);
